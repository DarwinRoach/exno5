function strg() { 
    ...
    document.getElementById('sh').innerHTML = arr[0];  document.getElementById('lg').innerHTML = arr[arr.length - 1]; } 
   function calculate(){
    
    var w = parseFloat(document.getElementById('weight').value);  var h = parseFloat(document.getElementById('height').value); 
    var bmi = w/(h*h); 
    document.getElementById('score').innerHTML = bmi; 
    if (bmi<18){ 
    document.getElementById('type').innerHTML = "Underweight";  } else if (bmi>=18 || bmi<=25){ 
    document.getElementById('type').innerHTML = "Normal";  } else if (bmi>=26 || bmi<=30){ 
    document.getElementById('type').innerHTML = "Overweight";  }else if (bmi>30){ 
    document.getElementById('type').innerHTML = "Obese";  }else{ 
   ...
   function grow() {  
    ...
    var img = '<img src=' + l[fruit] + ' width = "150px" height ="150px"></img>';  garden.innerHTML += img; 
    } 
    garden.innerHTML += "<br>"; 
    } 
   } 
   function convert(){ 
    ...
    document.getElementById('answer').innerHTML = (m*79.97);  } else if (f=="Indian Rupee" && t=="US Dollar"){ 
   ...
   function cake(){ 
    ...
    var cc = document.querySelector('input[name="tip"]:checked').value;  var tip = ((cc/100)*amt_tax); 
